            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="col-span-2 space-y-4">
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                        ...
                        {{-- Total Revenue --}}
                        <a href="{{ route('admin.plans.index') }}" class="group block p-4 bg-zinc-950/50 rounded-lg border border-zinc-800 hover:border-emerald-500/50 hover:bg-zinc-900 transition-all hover:scale-[1.02] hover:shadow-lg">
