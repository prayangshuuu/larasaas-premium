                ...
                <div class="bg-zinc-900 border border-zinc-800 rounded-xl p-6 flex flex-col hover:border-zinc-700 transition-colors group relative overflow-hidden">
                    ...
                    <div class="flex justify-between items-start mb-4 z-10">
                        <div class="flex items-center gap-3">
                            @if($plan->logo)
                                <img src="{{ asset('storage/' . $plan->logo) }}" alt="{{ $plan->name }}" class="h-10 w-10 rounded-lg object-cover border border-zinc-700 bg-zinc-800 shrink-0" />
                            @else
                                <div class="h-10 w-10 rounded-lg bg-zinc-800 border border-zinc-700 flex items-center justify-center shrink-0">
                                    <svg class="h-5 w-5 text-zinc-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" /></svg>
                                </div>
                            @endif
                            <div>
